...
public class ChemicalFiltersTest {
    ...
    public void testSortResultsByStereoAndBondMatch() throws Exception {
        ...
        Isomorphism smsd = new Isomorphism(queryac, target, Algorithm.DEFAULT, false);
        smsd.setChemFilters(false, false, false);
        assertEquals(4, smsd.getAllAtomMapping().size());

        Isomorphism smsd1 = new Isomorphism(queryac, target, Algorithm.DEFAULT, false);
    ...
    public void testSortResultsByFragments() throws InvalidSmilesException, CDKException {
        ...
        Isomorphism smsd = new Isomorphism(queryac, target,Algorithm.CDKMCS, false);
        smsd.setChemFilters(false, false, false);
        assertEquals(4, smsd.getAllAtomMapping().size());

        Isomorphism smsd1 = new Isomorphism(queryac, target, Algorithm.CDKMCS, false);
    ...
    public void testSortResultsByEnergies() throws Exception {
        ...
        Isomorphism smsd = new Isomorphism(queryac, target, Algorithm.DEFAULT, true);
        smsd.setChemFilters(false, false, false);
        assertEquals(4, smsd.getAllAtomMapping().size());

        Isomorphism smsd1 = new Isomorphism(queryac, target, Algorithm.DEFAULT, true);
