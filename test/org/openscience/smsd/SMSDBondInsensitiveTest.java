...
public class SMSDBondInsensitiveTest {
    ...
    public static void setUp() throws CDKException {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(Napthalene);
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(Cyclohexane);
    ...
    public void testVFLib() throws Exception {
        Isomorphism sbf = new Isomorphism(Algorithm.DEFAULT_1, false);
    ...
    public void testSMSDCyclohexaneBenzeneSubgraph() throws Exception {
        ...
        Isomorphism ebimcs1 = new Isomorphism(Algorithm.DEFAULT_1, false);
    ...
    public void testSMSDBondInSensitive() throws Exception {
        ...
        ebimcs2.init(Benzene, Napthalene);
    ...
    public void testCyclopropaneNotASubgraphOfIsoButane() throws Exception {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(cycloPropane);
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(isobutane);

        IAtomContainer source = AtomContainerManipulator.removeHydrogens(cycloPropane);
        IAtomContainer target = AtomContainerManipulator.removeHydrogens(isobutane);
...
//        Cyclopropane is not a subgraph of Isobutane
    ...
    public void testSingleMappingTesting() throws Exception {
        ...
        comparison.init(atomContainer, mol2);
        comparison.setChemFilters(stereoMatch, fragmentMinimization, energyMinimization);
...
//	Calling the main algorithm to perform MCS cearch
        ...
        Substructure comparison = new Substructure();
        comparison.init(source, target);
        Assert.assertEquals(true, comparison.findSubgraph(bondSensitive));
