...
public class VFLibTest {
    ...
    public static void setUp() throws CDKException {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(hexane);
        hexane = AtomContainerManipulator.removeHydrogens(hexane);
        CDKHueckelAromaticityDetector.detectAromaticity(hexane);
        QueryCompiler hexaneCompiler = new QueryCompiler(hexane, true);
        hexaneQuery = hexaneCompiler.compile();
        ...
        hexane = AtomContainerManipulator.removeHydrogens(benzene);
        CDKHueckelAromaticityDetector.detectAromaticity(benzene);
        QueryCompiler benzeneCompiler = new QueryCompiler(benzene, true);
        benzeneQuery = benzeneCompiler.compile();
    }
