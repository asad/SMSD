# SMSD 6.10.1 — Algorithms & Design

**Author**: Syed Asad Rahman, BioInception PVT LTD
**Version**: 6.10.1 | **Toolkit**: CDK 2.11 | **Language**: Java 21+ / C++17 / Python 3.9+ (recommended 3.12)

## Abstract

SMSD provides exact substructure and maximum common substructure (MCS) search
