...
public class VF2Substructure extends AbstractSubGraph implements IMCSBase {
    ...
    private final static ILoggingTool Logger =
            LoggingToolFactory.createLoggingTool(VF2Substructure.class);
