...
public final class MolHandler {
    ...
    public MolHandler(String MolFile, boolean removeHydrogen, boolean cleanMolecule) {
        ...
        try {
            ...
            this.atomContainer = (IMolecule) molRead.read(new GraphMolecule());
            molRead.close();
            readMolecule.close();
    ...
    /**
     * Creates a new instance of MolHandler
     * @param container GraphMolecule GraphAtomContainer
     * @param cleanMolecule
     * @param removeHydrogen
     */
    @TestMethod("MolHandlerTest")
    public MolHandler(IAtomContainer container, boolean removeHydrogen, boolean cleanMolecule) {
        ...
        if (removeHydrogen) {
            try {
                this.atomContainer = AtomContainerManipulator.removeHydrogens(atomContainer);
            } catch (Exception ex) {
                logger.error(ex);
            }
        }
