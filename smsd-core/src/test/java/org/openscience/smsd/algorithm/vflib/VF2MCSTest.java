...
public class VF2MCSTest {
    ...
    public void testRingSizeMatch() throws InvalidSmilesException {
        ...
        Isomorphism smsd1 = new Isomorphism(query, target, Algorithm.VFLibMCS, true, true, false);
        assertNotNull(smsd1.getFirstAtomMapping());
        assertEquals(6, smsd1.getFirstAtomMapping().getCount());
    }
    ...
    public void testComplexCaseR03165() throws InvalidSmilesException {
        ...
        Isomorphism smsd1 = new Isomorphism(query, target, Algorithm.VFLibMCS, false, false, false);
        assertNotNull(smsd1.getFirstAtomMapping());
        assertEquals(60, query.getAtomCount());
        assertEquals(61, target.getAtomCount());
        assertEquals(55, smsd1.getFirstAtomMapping().getCount());
    }
    ...
    public void testComplexCaseR09087() throws InvalidSmilesException {
        ...
        assertEquals(36, smsd1.getFirstAtomMapping().getCount());
    }
}
